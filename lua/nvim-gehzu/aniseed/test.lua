local _0_0
do
  local name_0_ = "nvim-gehzu.aniseed.test"
  local module_0_
  do
...
local function _1_(...)
  ...
  local function _1_()
    return {autoload("nvim-gehzu.aniseed.core"), autoload("nvim-gehzu.aniseed.nvim"), autoload("nvim-gehzu.aniseed.string")}
  end
  ok_3f_0_, val_0_ = pcall(_1_)
  if ok_3f_0_ then
    _0_0["aniseed/local-fns"] = {autoload = {a = "nvim-gehzu.aniseed.core", nvim = "nvim-gehzu.aniseed.nvim", str = "nvim-gehzu.aniseed.string"}}
    return val_0_
  else
    return print(val_0_)
  end
...
local _2amodule_name_2a = "nvim-gehzu.aniseed.test"
