local _0_0
do
  local name_0_ = "nvim-gehzu.aniseed.compile"
  local module_0_
  do
...
local function _1_(...)
  ...
  local function _1_()
    return {autoload("nvim-gehzu.aniseed.core"), autoload("nvim-gehzu.aniseed.fennel"), autoload("nvim-gehzu.aniseed.fs"), autoload("nvim-gehzu.aniseed.nvim")}
  end
  ok_3f_0_, val_0_ = pcall(_1_)
  if ok_3f_0_ then
    _0_0["aniseed/local-fns"] = {autoload = {a = "nvim-gehzu.aniseed.core", fennel = "nvim-gehzu.aniseed.fennel", fs = "nvim-gehzu.aniseed.fs", nvim = "nvim-gehzu.aniseed.nvim"}}
    return val_0_
  else
    return print(val_0_)
  end
...
local _2amodule_name_2a = "nvim-gehzu.aniseed.compile"
...
do
  ...
  do
    ...
    local function macros_prefix0(code)
      local macros_module = "nvim-gehzu.aniseed.macros"
