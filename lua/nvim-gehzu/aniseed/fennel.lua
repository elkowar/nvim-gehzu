local _0_0
do
  local name_0_ = "nvim-gehzu.aniseed.fennel"
  local module_0_
  do
    ...
    if ("table" == type(x_0_)) then
      ...
      module_0_ = require("nvim-gehzu.aniseed.deps.fennel")
    end
  end
...
local function _1_(...)
  ...
  local function _1_()
    return {autoload("nvim-gehzu.aniseed.deps.fennel"), autoload("nvim-gehzu.aniseed.nvim")}
  end
  ok_3f_0_, val_0_ = pcall(_1_)
  if ok_3f_0_ then
    _0_0["aniseed/local-fns"] = {autoload = {fennel = "nvim-gehzu.aniseed.deps.fennel", nvim = "nvim-gehzu.aniseed.nvim"}}
    return val_0_
  else
    return print(val_0_)
  end
...
local _2amodule_name_2a = "nvim-gehzu.aniseed.fennel"
