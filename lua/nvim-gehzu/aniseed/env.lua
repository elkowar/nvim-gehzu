local _0_0
do
  local name_0_ = "nvim-gehzu.aniseed.env"
  local module_0_
  do
...
local function _1_(...)
  ...
  local function _1_()
    return {autoload("nvim-gehzu.aniseed.nvim")}
  end
  ok_3f_0_, val_0_ = pcall(_1_)
  if ok_3f_0_ then
    _0_0["aniseed/local-fns"] = {autoload = {nvim = "nvim-gehzu.aniseed.nvim"}}
    return val_0_
  else
    return print(val_0_)
  end
...
local _2amodule_name_2a = "nvim-gehzu.aniseed.env"
  ...
  do
    ...
    local function init0(opts)
      ...
      if ((false ~= opts0.compile) or os.getenv("ANISEED_ENV_COMPILE")) then
        local compile = require("nvim-gehzu.aniseed.compile")
        local fennel = require("nvim-gehzu.aniseed.fennel")
